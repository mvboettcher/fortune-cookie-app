...
},{"./lib/ReactPropTypesSecret":42}],14:[function(require,module,exports) {
...
},{"./isNode":50}],27:[function(require,module,exports) {
'use strict';
...
},{"fbjs/lib/invariant":19,"react":8,"fbjs/lib/warning":21,"fbjs/lib/ExecutionEnvironment":24,"object-assign":18,"fbjs/lib/emptyFunction":22,"prop-types/checkPropTypes":23,"fbjs/lib/getActiveElement":25,"fbjs/lib/shallowEqual":26,"fbjs/lib/containsNode":27,"fbjs/lib/emptyObject":20,"fbjs/lib/hyphenateStyleName":28,"fbjs/lib/camelizeStyleName":29}],9:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-dom.development.js":15}],59:[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":59}],57:[function(require,module,exports) {

var reloadCSS = require('_css_loader');
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":58}],6:[function(require,module,exports) {
'use strict';
...
var Component = function (_React$Component) {
	...
	function Component() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Component.__proto__ || Object.getPrototypeOf(Component)).call.apply(_ref, [this].concat(args))), _this), _this.state = _this.props.initialState || {}, _temp), _possibleConstructorReturn(_this, _ret);
	}

	_createClass(Component, [{
		key: 'render',
		value: function render() {
			var ChildComponent = this.props.children;
			return _react2.default.createElement(ChildComponent, { state: this.state, setState: this.setState.bind(this) });
		}
	}]);
...
},{"react":8}],55:[function(require,module,exports) {
module.exports = [
...
},{"./fortune-cookie.json":55}],56:[function(require,module,exports) {
'use strict';
...
var _appCss = require('./app.css.js');
...
var App = function App(props) {
	...
	var getFortune = function getFortune() {
		var number = getRandomInt(_fortuneCookie2.default.length - 1);
		return {
			fortune: _fortuneCookie2.default[number]
		};
	};

	return _react2.default.createElement(
		'div',
		{ style: _appCss2.default.root },
		...
		_react2.default.createElement(
			'h3',
			{ className: 'mh2 ba pa4 br2 bg-light-blue' },
			state.fortune
		),
		_react2.default.createElement(
			'button',
			{
				style: _appCss2.default.button,
		...
		_react2.default.createElement(
			...
			'Click button to get fortune'
		)
	);
};

exports.default = App;
},{"react":8,"fortune-cookie":54,"./app.css.js":56}],4:[function(require,module,exports) {
'use strict';
...
},{"react":8,"react-dom":9,"./index.css":57,"./component":6,"./app":7}],32:[function(require,module,exports) {
...
//# sourceMappingURL=/src.13334826.map